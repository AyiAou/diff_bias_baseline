...
folder_path = './autodl-tmp/'

folders_and_prompts = {
    "white": "a photo of a white person",
    "black": "a photo of a black person",
    "indian": "a photo of an indian",
    "asian": "a photo of an asian"
}
...
for second_folder_path, input_image_prompt in folders_and_prompts.items():
    ...
    for filename in tqdm(os.listdir(folder_full_path), desc=f"Processing {second_folder_path}"):
        try:
            ...
            output_folder = os.path.join('./autodl-tmp', f'{second_folder_path}_outputs', base_filename)
